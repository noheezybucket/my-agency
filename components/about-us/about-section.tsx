        ...
        <section>
            <div className="section-width rounded-lg space-y-5">
                ...
                <p className={'text2xl lg:text-2xl font-thin lg:leading-10 text-justify'}>
                    At <b className={'font-bold'}>Digital Artisan Studio</b>, we’re passionate about crafting impactful digital experiences that set
                    brands apart.
                    ...
                    media presence,
                    or develop a custom web or mobile solution, <b>Dartisan Studio</b> is here to make it happen. Let’s
